...
from .network_split_operation import InpaintGenerator, EdgeGenerator, Discriminator
...
class BaseModel(nn.Module):
    ...
    def load(self, type):
        load_path=type[:-8]
        self.gen_weights_path =load_path + '_gen.pth'
        self.dis_weights_path =load_path + '_dis.pth'
...
class InpaintingModel(BaseModel):
    def __init__(self, config):
        ...
        print('parameter count: {}'.format(get_n_params(generator)))
        l1_loss = nn.L1Loss()
